...
system("perl -w -I lib $script --hetfile $testhet --vartrans --ref $testref --outdir t/test1out --normalbam $normalbam --tumorbam $tumorbam > t/calltest1.out 2>&1");
...
system("perl -w -I lib $script --hetfile $testhet --vartrans --ref $testref --outdir t/test1out --normalbam $normalbam --tumorbam $tumorbam --diploid --skipcounts > t/calltest2.out 2>&1");
